...
To ensure reproducibility, the code below demonstrates how to access the dataset. Although a local copy is used here to speed up processing, the `recount` package can be used to download it directly.
